...
% JDCS: 표 내부는 영문, 캡션은 표 위 국문+영문 병기
\begin{table*}[t]
\centering\scriptsize\setlength{\tabcolsep}{3pt}
\caption{정간보 관련 도구·연구와의 기능 비교
(\(\bullet\)=지원, \(\circ\)=부분 지원, ---=미지원)\\
Table~\thetable. Feature comparison with existing jeongganbo tools and
studies (\(\bullet\)=supported, \(\circ\)=partial, ---=unsupported)}
\label{tab:compare}
\begin{tabular}{@{}lcccccc@{}}
\toprule
 & Ours & XML encoding~\cite{lee2013xml} & Web design~\cite{jkca2022web}
 & Web editor~\cite{jeongganbo-editor-web} & HWP tables & MuseScore~\cite{musescore} \\
\midrule
Human-readable text grammar      & \(\bullet\) & --- & --- & --- & --- & --- \\
WYSIWYG editing                  & \(\bullet\) & --- & \(\circ\) & \(\bullet\) & \(\bullet\) & \(\bullet\) \\
Positional duration (subdivision) & \(\bullet\) & \(\bullet\) & \TODO{확인} & \(\circ\) & \(\circ\) & --- \\
Sigimsae ornaments               & \(\bullet\)(59) & \(\circ\) & \TODO{확인} & --- & \(\circ\)(manual) & --- \\
Rhythm and lyric layers          & \(\bullet\) & \(\circ\) & \TODO{확인} & --- & \(\circ\)(manual) & --- \\
Right-to-left layout with daegang & \(\bullet\) & \(\circ\) & \TODO{확인} & \(\circ\) & \(\circ\)(manual) & --- \\
Playback                         & \(\bullet\) & \(\circ\) & --- & --- & --- & \(\bullet\)(staff) \\
Print/PDF/PNG export             & \(\bullet\) & --- & --- & \(\circ\)(PNG) & \(\bullet\) & \(\bullet\) \\
Structured interchange           & \(\bullet\)(JSON) & \(\bullet\)(XML) & \TODO{확인} & \(\circ\)(JSON) & --- & \(\bullet\)(MusicXML) \\
Serverless offline use           & \(\bullet\) & N/A & \TODO{확인} & --- & \(\bullet\) & \(\bullet\) \\
\bottomrule
\end{tabular}
\end{table*}
...
과제 기반 평가(기존 HWP 조판 대비 작성 시간·오류율·SUS(system usability
scale) 점수)를 수행하는
것이 후속 과제다. \TODO{투고 전 소규모라도 사용자 평가를 실시해 Ⅴ장을
