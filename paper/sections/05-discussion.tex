...
\subsection{사례 연구: 대취타 악보 재현}

국립국악원 간행 악보의 취타·군악을 대상으로 원본 지면과 동일한 배치
(12정간, 대강 3·3·3·3, 세로 제목 칸, 장단 열, 시김새 포함)를 재현했다.
\TODO{그림: 원본 악보 스캔과 본 시스템 출력의 나란한 비교. 재현에 걸린
입력 시간, 텍스트 소스 길이(자 수), 페이지 수 등 정량 정보 기입}
전 과정에 서버 통신이 없고, 완성 문서는 12KB 수준의 \code{.jgb.json}
하나로 보존·공유된다. \TODO{실제 파일 크기 측정해 교체}
