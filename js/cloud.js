...
(function () {
  ...
  // 공유마당(공개 목록)를 열어 두었는가 — 운영 스위치. 닫혀 있으면 목록으로 가는 길과
  ...
  // 공유마당를 닫아 둔 동안은 목록으로 가는 길도 없앤다 — 눌러 봐야 '준비 중'만 나오는
  ...
  // ---------- 미리보기 그림 ----------
  // 공유마당 목록의 카드에 쓸 그림. 서버는 악보를 그릴 줄 모르지만 **브라우저는 이미 그려
  ...
  function openPubModal() {
    ...
    // 공유마당를 닫아 둔 동안엔 고를 것이 없다 — 목록이 없는데 '목록에 올리기'를 물으면
