// symbols-data.js 생성기.
//   symbol_svgs/{symbols,tempo,special} 세 폴더의 .svg 를 base64 data URL 로 묶어
...
const SVG_ROOT = join(ROOT, "symbol_svgs");
...
const out =
  "// 자동 생성(tools/gen-symbols-data.mjs) — symbol_svgs/{symbols,tempo,special} SVG를 base64로 내장. 직접 편집 금지.\n" +
  "window.SYM_DATA = {\n" +
  body +
  "\n};\n";

writeFileSync(join(ROOT, "symbols-data.js"), out);
console.log("symbols-data.js 재생성 완료 — " + entries.length + "개 키");
